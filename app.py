...
# type
Any = st.selectbox('Type',df['TypeName'].unique())
...
if st.button('Predict Price'):
    ...
    type_idx = np.where(df['TypeName'].unique() == Any)[0][0]
    ...
    query = np.array([company,Any,ram,weight,ips,touchscreen,ppi,cpu,hdd,ssd,gpu,os],dtype=object)
